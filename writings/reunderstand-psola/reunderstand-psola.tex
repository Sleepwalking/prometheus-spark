...
\begin{figure}[H]
\centering
\scalebox{.65}{\input{psola-wb-no-offset.tikz}}
\scalebox{.65}{\input{psola-wb-20-offset.tikz}}
\caption{}
\label{fig:psola-wb}
\end{figure}
...
\begin{figure}[H]
\centering
\scalebox{.65}{\input{psola-wb-mfpa-offset.tikz}}
\caption{}
...
\begin{figure}[H]
\centering
\scalebox{.6}{\input{psola-wb-zero-phase.tikz}}
\scalebox{.6}{\input{psola-wb-random-phase.tikz}}
\caption{}
